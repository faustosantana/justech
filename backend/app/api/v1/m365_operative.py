...
@router.get("/dashboard", response_model=M365OperativeDashboard)
...
@router.get("/emails", response_model=M365ProcessedEmailListResponse)
...
@router.get("/emails/{email_id}", response_model=M365ProcessedEmailResponse)
...
@router.post("/sync", response_model=M365SyncResponse)
...
@router.post("/emails/{email_id}/actions", response_model=M365ExecuteActionResponse)
...
@router.get("/calendar/suggestions", response_model=M365CalendarSuggestionsResponse)
