...
export const MODULE_REGISTRY: ModuleDefinition[] = [
  ...
  },
  {
    ...
    searchPlaceholder: "Buscar número, lotería, relación…",
    dashboardSubtitle: "Inteligencia histórica sobre las siete loterías activas",
    copilotSuggestions: [
      "Historial del número 50 en las siete activas",
      "Comparar confirmadores de Leidsa y Loteka",
      "Relaciones de Tabla 1 y Tabla 2 para 35",
    ],
    defaultQuickActions: [
      qa("inicio", "Inteligencia", Brain, "/lottery"),
      qa("historial", "Historial", FileSearch, "/lottery/admin/control-center/motor/historial-numero"),
      qa("comparador", "Comparador", TrendingUp, "/lottery/admin/control-center/motor/comparador"),
    ...
    sections: [
      ...
      },
      {
        ...
        group: "Inicio",
        shortDescription: "Las siete loterías activas y su ficha",
      },
      {
        id: "chat",
        label: "Lotería IA",
        ...
        group: "Inicio",
        shortDescription: "Copiloto conversacional sobre el universo activo",
      },
      {
        id: "favoritos",
        label: "Favoritos",
      ...
      },
      {
        ...
        icon: FileSearch,
        contentKey: "lottery:historial",
        views: ["list"],
        legacyHref: "/lottery/admin/control-center/motor/historial-numero",
        group: "Análisis",
        shortDescription: "Expediente histórico de un número (1–100)",
      },
      {
        id: "comparador",
        label: "Comparador",
        icon: TrendingUp,
        contentKey: "lottery:comparador",
        views: ["charts"],
        legacyHref: "/lottery/admin/control-center/motor/comparador",
        group: "Análisis",
        shortDescription: "Comparar candidatos, confirmadores y loterías",
      },
      {
        id: "validation-lab",
        label: "Validation Lab",
        icon: Microscope,
        contentKey: "lottery:validation-lab",
        views: ["list"],
        legacyHref: "/lottery/admin/control-center/motor/validation-lab",
        group: "Análisis",
      ...
      },
      {
        ...
        label: "Tabla 1",
        icon: BarChart3,
        contentKey: "lottery:tabla1",
        views: ["list"],
        legacyHref: "/lottery/admin/control-center/motor/table1",
        group: "Motor",
        shortDescription: "Consulta de compañeros (Tabla 1)",
      },
      {
        id: "tabla2",
        label: "Tabla 2",
        icon: LineChart,
        contentKey: "lottery:tabla2",
        views: ["list"],
        legacyHref: "/lottery/admin/control-center/motor/table2",
        group: "Motor",
        shortDescription: "Consulta de confirmadores (Tabla 2)",
      },
      {
        id: "agrupaciones",
        label: "Agrupaciones",
        icon: FolderOpen,
        contentKey: "lottery:agrupaciones",
        views: ["list"],
        legacyHref: "/lottery/admin/control-center/motor/agrupaciones",
        group: "Motor",
        shortDescription: "Grupos de Tabla 1 y Tabla 2 en una sola vista",
      },
      {
        id: "relaciones",
        label: "Relaciones",
        icon: Workflow,
        contentKey: "lottery:relaciones",
        views: ["list"],
        legacyHref: "/lottery/admin/control-center/motor/relaciones",
        group: "Motor",
        shortDescription: "Mapa N → compañero → confirmador",
      },
      {
        id: "auditoria",
        label: "Auditoría",
        icon: ClipboardList,
        contentKey: "lottery:auditoria",
        views: ["list"],
        legacyHref: "/lottery/admin/control-center/motor/auditoria",
        group: "Motor",
        shortDescription: "Trazabilidad por sorteo y estado de confirmación",
      },
      {
        id: "historico",
        label: "Histórico (consulta)",
        icon: FileStack,
        contentKey: "lottery:historico",
        views: ["list"],
        legacyHref: "/lottery/admin/control-center/motor/historico",
        group: "Avanzado",
        shortDescription: "Consulta condicionada avanzada del histórico",
      },
      {
        id: "matriz",
        label: "Matriz",
        icon: Target,
        contentKey: "lottery:matriz",
        views: ["charts"],
        legacyHref: "/lottery/admin/control-center/motor/combinaciones",
        group: "Avanzado",
        shortDescription: "Matriz de combinaciones históricas",
      },
      {
        id: "patron",
        label: "Patrón",
        icon: Calendar,
        contentKey: "lottery:patron",
        views: ["charts"],
        legacyHref: "/lottery/admin/control-center/motor/patron",
        group: "Avanzado",
        shortDescription: "Patrones históricos de confirmación",
      },
      {
        id: "predicciones",
        label: "Predicciones",
        icon: Sparkles,
        contentKey: "lottery:predicciones",
        views: ["list"],
        legacyHref: "/lottery/admin/control-center/predicciones",
        group: "Avanzado",
        shortDescription: "Motores de predicción (solo consulta)",
      },
      {
        id: "guardadas",
      ...
      },
      {
        ...
        roles: ["owner", "admin", "superadmin"],
        shortDescription: "Visibilidad, featured y sync por lotería",
      },
      {
        id: "admin-archivo",
        label: "Archivo histórico",
        icon: FolderOpen,
        contentKey: "lottery:admin-archivo",
        views: ["list"],
        legacyHref: "/lottery/admin/lotteries/archivo-historico",
        group: "Administración",
        roles: ["owner", "admin", "superadmin"],
        shortDescription: "Inventario fuera del universo de las siete activas",
      },
      {
        id: "admin-sync",
      ...
      },
      {
        ...
        label: "Prompt Studio",
        icon: Brain,
        contentKey: "lottery:prompt-studio",
        views: ["list"],
        legacyHref: "/lottery/admin/control-center/prompt-studio",
        group: "Administración",
        roles: ["owner", "admin", "superadmin"],
        shortDescription: "Prompts compilados y playground administrable",
      },
      {
        id: "admin-ai",
        label: "Centro de IA",
        ...
        group: "Administración",
        roles: ["owner", "admin", "superadmin"],
        shortDescription: "Agente, modelos, memoria y herramientas IA",
      },
    ],
  },
  {
...
/** Mapa canónico menú Lottery IA → ruta App Router (pruebas de integridad). */
export const LOTTERY_NAV_INTEGRITY: { contentKey: string; href: string; group: string }[] = [
  ...
  { contentKey: "lottery:chat", href: "/lottery/chat", group: "Inicio" },
  { contentKey: "lottery:favorites", href: "/lottery/favorites", group: "Inicio" },
  {
    contentKey: "lottery:historial",
  ...
  { contentKey: "lottery:tabla1", href: "/lottery/admin/control-center/motor/table1", group: "Motor" },
  { contentKey: "lottery:tabla2", href: "/lottery/admin/control-center/motor/table2", group: "Motor" },
  {
    contentKey: "lottery:agrupaciones",
  ...
  {
    contentKey: "lottery:historico",
    href: "/lottery/admin/control-center/motor/historico",
    group: "Avanzado",
  },
  {
    contentKey: "lottery:matriz",
    href: "/lottery/admin/control-center/motor/combinaciones",
    group: "Avanzado",
  },
  { contentKey: "lottery:patron", href: "/lottery/admin/control-center/motor/patron", group: "Avanzado" },
  {
    contentKey: "lottery:predicciones",
    href: "/lottery/admin/control-center/predicciones",
    group: "Avanzado",
  },
  { contentKey: "lottery:saved", href: "/lottery/saved", group: "Avanzado" },
