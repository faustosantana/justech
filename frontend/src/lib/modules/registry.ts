...
export const MODULE_REGISTRY: ModuleDefinition[] = [
  ...
  },
  {
    ...
    defaultQuickActions: [
      qa("mis", "Mis Licitaciones", ClipboardList, moduleSectionHref("licitaciones", "mis-licitaciones")),
    ...
    sections: [
      { id: "mis-licitaciones", label: "Mis Licitaciones", icon: ClipboardList, contentKey: "licitaciones:mis-licitaciones", views: ["list"], group: "Operación" },
      { id: "mis-pendientes", label: "Mis Pendientes", icon: ClipboardList, contentKey: "licitaciones:mis-pendientes", views: ["list"], group: "Operación" },
      ...
      { id: "checklist-plantillas", label: "Plantillas checklist", icon: ClipboardList, contentKey: "licitaciones:checklist-plantillas", views: ["list"], group: "Configuración" },
  ...
  },
  {
    ...
    label: "Lottery IA",
    icon: Brain,
    accent: "bg-blue-500/12 text-blue-800",
    routePrefixes: ["/lottery", "/apps/lottery"],
    searchPlaceholder: "Buscar número, lotería, resultado…",
    dashboardSubtitle: "Resultados, análisis y chat inteligente",
    copilotSuggestions: [
      "Analiza el 35",
      "Muéstrame los resultados de hoy",
      "¿Por qué aparece recomendado el 54?",
    ],
    defaultQuickActions: [
      qa("inicio", "Inicio", Brain, "/lottery"),
      qa("analizar", "Analizar", Search, "/lottery/analizar"),
      qa("resultados", "Resultados", Calendar, "/lottery/resultados"),
      qa("chat", "Chat inteligente", Sparkles, "/lottery/chat"),
    ],
    sections: [
      {
        id: "inicio",
        ...
        legacyHref: "/lottery",
        group: "Lottery IA",
        shortDescription: "Estado, resultados recientes y accesos rápidos",
      },
      {
        id: "analizar",
        label: "Analizar números",
        icon: Search,
        contentKey: "lottery:analizar",
        views: ["list"],
        legacyHref: "/lottery/analizar",
        group: "Lottery IA",
        shortDescription: "Análisis completo de uno o más números",
      },
      {
        id: "resultados",
        label: "Resultados",
        icon: Calendar,
        contentKey: "lottery:resultados",
        views: ["list"],
        legacyHref: "/lottery/resultados",
        group: "Lottery IA",
        shortDescription: "Resultados e histórico por fecha, lotería o número",
      },
      {
        id: "patrones",
        label: "Patrones y tablas",
        icon: Table2,
        contentKey: "lottery:patrones",
        views: ["list"],
        legacyHref: "/lottery/patrones",
        group: "Lottery IA",
        shortDescription: "Tabla 1, Tabla 2 y Patrón Matriz",
      },
      {
        id: "chat",
        ...
        group: "Lottery IA",
        shortDescription: "Asistente conectado a datos reales del módulo",
      },
      {
        id: "administracion",
        label: "Administración",
        icon: Settings,
        contentKey: "lottery:administracion",
        views: ["list"],
        legacyHref: "/lottery/administracion",
        group: "Lottery IA",
        roles: ["owner", "admin", "superadmin"],
        shortDescription: "Sincronización, prompts, motor y auditorías",
      },
      // Hidden legacy routes (capabilities preserved, not in main menu)
      {
        id: "ia-dashboard",
        label: "Motor (detalle)",
        icon: Activity,
...
export const LOTTERY_NAV_INTEGRITY: { contentKey: string; href: string; group: string }[] = [
  { contentKey: "lottery:dashboard", href: "/lottery", group: "Lottery IA" },
  { contentKey: "lottery:analizar", href: "/lottery/analizar", group: "Lottery IA" },
  { contentKey: "lottery:resultados", href: "/lottery/resultados", group: "Lottery IA" },
  { contentKey: "lottery:patrones", href: "/lottery/patrones", group: "Lottery IA" },
  { contentKey: "lottery:chat", href: "/lottery/chat", group: "Lottery IA" },
  { contentKey: "lottery:administracion", href: "/lottery/administracion", group: "Lottery IA" },
];
