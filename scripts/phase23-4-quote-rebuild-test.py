# -*- coding: utf-8 -*-
"""Fase 23.4 — Validación template cotización premium reconstruido."""
...
OUT_DIR = "/tmp/phase23-4-quote-rebuild"
os.makedirs(OUT_DIR, exist_ok=True)

report = {
    "phase": "23.4-quote-template-rebuild",
...
print("PHASE23_4:" + json.dumps(report, indent=2, ensure_ascii=False))
